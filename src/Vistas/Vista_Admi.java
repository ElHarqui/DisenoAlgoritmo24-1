...
public class Vista_Admi extends javax.swing.JPanel {
    ...
    public Vista_Admi() {
        ...
        llenarTablaVendedor(GesVendedor);
    ...
    private void agregarModeloTablaEmpleado(){
        modeloVendedor.addColumn("Codigo"); 
        modeloVendedor.addColumn("Nombre");
        modeloVendedor.addColumn("Apellido");         
     }
    private void llenarTablaProductos(GestionadorProducto GesProduct){
        //DATOS
    ...
    public void AgregarProductoTabla(GestionadorProducto GesProduct){

        int i = GesProduct.getnumDato()-1;
        Object[] fila = {GesProduct.getProducto(i).getID(), GesProduct.getProducto(i).getNombre(), GesProduct.getProducto(i).getPrecio(),GesProduct.getProducto(i).getCantidad()};
        modeloProducto.addRow(fila);
        if (vistaVendedor != null) {
            vistaVendedor.actualizarTablaProductos(GesProduct);
        }
    }
    private void AgregarVendedorTabla(GestionadorVendedor GesVende){

        int i = GesVende.cantidadPersona()-1;
            Object[] fila = {GesVende.getPersona(i).getCodigo(), GesVende.getPersona(i).getNombre(), GesVende.getPersona(i).getApellido()};
    ...
    /*
     ...
     public void llenarTablaVendedor(GestionadorVendedor unPersona){   
        ...
        for( int i=0; i<cantidadDatos; i++){
            ...
            modeloVendedor.addRow(listaVendedores);
        }        
        }
    }
    ...
    private void initComponents() {
        ...
        tblVendedor.setModel(modeloVendedor);
        ...
        TablasLayout.setVerticalGroup(
            ...
            .addGroup(TablasLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(TablasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton5)
                    .addComponent(jButton6))
                .addGap(82, 82, 82))
        );
    ...
    private void btn_RegistrarVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarVendedorActionPerformed
        ...
        GesVendedor.Registrar(nombre,apellido, codigo);
        JOptionPane.showMessageDialog(null, "Vendedor registrado");   
        AgregarVendedorTabla(GesVendedor);
    ...
    private void btn_RegistrarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarProductoActionPerformed
        ...
        AgregarProductoTabla(GesProduct);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if(fila==-1){
                ...
                modeloVendedor.removeRow(tblVendedor.getSelectedRow());
                GesVendedor.Eliminar(codigo);
